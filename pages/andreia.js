...
function Home() {
  const whatsappLink =
    "https://wa.me/5532988201668?text=Melhor%20filho%20do%20Mundo!";
  ...
  return (
    <>
      ...
      <div className="page-container">
        <div className="card">
          <h1 className="title">Melhor mãe do mundo!</h1>

          <div className="spotify-container">
            <iframe
              data-testid="embed-iframe"
              // CORREÇÃO AQUI: de string para objeto
              style={{ borderRadius: "12px" }}
              src="https://open.spotify.com/embed/track/3TPVkq85S5r0EoXZHn5zxU?utm_source=generator"
              width="100%"
              height="152"
              frameBorder="0"
              allowFullScreen=""
          ...
          <div className="text-container">
            <p className="text-highlight">Feliz Dia das Mulheres, mamãe!</p>
